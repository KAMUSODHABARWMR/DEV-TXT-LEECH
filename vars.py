...
# API Configuration
API_ID = int(os.environ.get("API_ID", "21442913"))
API_HASH = os.environ.get("API_HASH", "b95b8bae367e19c3356b9f0004b218c2")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")

CREDIT = os.environ.get("CREDIT", "⌯ Kuɴwar Sa Sodha❤️ | ×͜× |")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "7197125636"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "7197125636").split()]  # Default to owner ID

# Channel Configuration
PREMIUM_CHANNEL = "https://t.me/+zzgp8DUgaic3MzRl"
# Thumbnail Configuration
THUMBNAILS = list(map(str, os.environ.get("THUMBNAILS", "https://files.catbox.moe/49opqf.jpg").split())) # Image Link For Default Thumbnail 
